glimpse.data = (function ($, pubsub, util) {
    var innerBaseMetadata = { plugins: {}, resources: {} }, innerBaseData = { data: {}, metadata: innerBaseMetadata, uri: window.location.href }, innerCurrentData = innerBaseData, generateRequestAddress = function (requestId) {
