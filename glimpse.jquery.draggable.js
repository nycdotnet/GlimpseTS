(function ($) {
    var defaults = {
        ...
        getDimension: function () {
            return parseInt(this.resizeScope.css(this.valueStyle));
        },
        setDimension: function (value) {
            return this.resizeScope.css(this.valueStyle, value + 'px');
        }
        ...
        var settings = e.data.settings, newDimension = settings._startDimension + ((mousePosition(e) - settings._startMousePosition) * settings.offset);
